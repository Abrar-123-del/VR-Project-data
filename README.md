1.  The **Original Dataset** is the Dataset with the VR application areas, where the features **"N"** and **"%"** stands for the number of applications in each Area and the percentage of the total sample, respectively.
